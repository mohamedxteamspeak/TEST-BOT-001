...
module.exports = {
    ...
    URL_1LINK: process.env.URL_1LINK === undefined ? 'http://instagram.com/dolipran_009' : process.env.URL_1LINK,
    URL_2NAME: process.env.URL_2NAME === undefined ? '✨Star on Github✨' : process.env.URL_2NAME,
    URL_2LINK: process.env.URL_2LINK === undefined ? 'https://github.com/mohamedxteamspeak/TEST-BOT-001' : process.env.URL_2LINK,
    FOOTER: process.env.FOOTER === undefined ? 'BOBIZBOT-MD  instagram.com/dolipran_009 تابعني على الانستغرام ' : process.env.FOOTER,
    CAPTION: process.env.CAPTION === undefined ? '🐶 𝙱𝙾𝙱𝙸𝚉 𝙱𝙾𝚃 𝙼𝙳 https://www.instagram.com/dolipran_009  🐕' : process.env.CAPTION,
